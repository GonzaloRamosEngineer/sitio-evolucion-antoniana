...
import { ArrowLeft, Globe, Mail, Phone, Info } from 'lucide-react';
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        {partner.nombre} colabora activamente con nuestros proyectos de desarrollo social y deportivo, ofreciendo beneficios exclusivos a nuestra comunidad.
                      </p>
                    </div>
                  </div>
                </div>
