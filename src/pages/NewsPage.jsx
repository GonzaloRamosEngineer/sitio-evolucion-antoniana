          ...
          <div className="max-w-6xl mx-auto">
            {news.length === 0 ? (
              <div className="text-center py-16">
                <p className="text-xl text-gray-600">Próximamente compartiremos nuestras novedades por aquí.</p>
              </div>
            ) : (
                  ...
                  >
                    ...
                    <div className="p-6 flex-grow flex flex-col">
                      <div className="flex items-center gap-2 text-sm text-gray-500 mb-2">
                        ...
                        <span>{newsItem.created_at ? new Date(newsItem.created_at).toLocaleDateString() : ''}</span>
                      </div>
                      <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors">
                        <Link to={`/novedades/${newsItem.id}`}>{newsItem.title}</Link>
                      </h3>
