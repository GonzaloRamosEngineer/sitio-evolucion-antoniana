  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        ...
        <meta name="description" content="Mantente al día con las últimas noticias y actividades de la Fundación." />
      </Helmet>
            ...
            {news.length === 0 ? (
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {news.map((newsItem, index) => (
                  ...
                  >
                    <Link to={`/novedades/${newsItem.id}`} className="block h-48 bg-gray-200 overflow-hidden">
                      {newsItem.image_url ? (
                        <img 
                        ...
                        <div className="w-full h-full bg-gradient-to-br from-blue-100 to-sky-200 flex items-center justify-center">
                           <span className="text-blue-300 font-bold text-xl text-center p-4">Fundación Evolución Antoniana</span>
                        </div>
                      )}
                    </Link>
                    <div className="p-6 flex-grow flex flex-col">
                      ...
                      <Link to={`/novedades/${newsItem.id}`} className="mt-auto self-start font-semibold text-blue-600 hover:text-blue-800 transition-colors flex items-center gap-2">
