...
const PartnersAdmin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      orden: Number.isFinite(Number(formData.orden)) ? Number(formData.orden) : 1000, // normaliza
    };
  ...
  const handleEdit = (partner) => {
    ...
    setFormData({
      ...
      orden: partner.orden ?? 1000, // nuevo
    });
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-sm font-semibold text-gray-900">Orden</th>{/* nuevo */}
              ...
              {partners.length === 0 ? (
                ...
                partners.map((partner, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span className={`inline-flex px-3 py-1 rounded-full text-xs font-semibold ${getStatusBadge(partner.estado)}`}>
                        {partner.estado}
                      </span>
                    </td>
                    <td className="px-6 py-4 text-sm text-gray-700">{partner.orden ?? 1000}</td>{/* nuevo */}
